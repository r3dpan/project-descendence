...
// Self-service password change - the one Settings tab every authenticated
// user can reach, unlike Users/Tokens/Configuration which are gated on
// permissions. Gated by "acting on self" server-side (decision #5's
// carve-out), not a permission key, so there is nothing to check
// client-side beyond being logged in.
